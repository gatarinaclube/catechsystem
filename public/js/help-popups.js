(function () {
  const contextualHelp = {
    ...
    "Aviso automático de vacinas": "Ative o envio de e-mail para vacinas próximas do vencimento, defina a antecedência, escolha os grupos de gatos e configure o calendário de primeira dose e reforços.",
    ...
    "Configurações": "Ajuste dados do gatil, veterinário, logo, raças, exames, alertas automáticos de vacina e limites dos perfis.",
